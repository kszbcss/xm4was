...
final class LogMessageJsonFormatter {
    ...
    String toJson(LogMessage message) {
        ...
        json.append(", ");
        writeField(json, "was.cell", cell);
        json.append(", ");
        writeField(json, "was.node", node);
        json.append(", ");
        writeField(json, "was.server", server);
        json.append(", ");
        writeField(json, "was.application", message.getApplicationName());
        json.append(", ");
        writeField(json, "was.module", message.getModuleName());
        json.append(", ");
        writeField(json, "was.component", message.getComponentName());
        json.append(", ");
