...
public interface EJBMonitorMBean {
    @Operation(description="Validates the given stateless session bean. This operation has the " +
            "same effect as other validateStatelessSessionBean with a timeout of 60 seconds.",
    ...
    String validateStatelessSessionBean(
            ...
            @Parameter(name="beanName", description="The bean name")
            String beanName,
            @Parameter(name="timeout", description="The number of milliseconds to wait for the completion of "
                    + "the initialization of the bean; if the timeout is exceeded, a TimeoutException will be thrown")
    ...
    String validateAllStatelessSessionBeans() throws Exception;
}
